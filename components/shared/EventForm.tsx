      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            ...
            <Image src="/assets/icons/location-grey.svg" height={24} width={24} alt="calender" />
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            ...
            <Image src="/assets/icons/calendar.svg" height={24} width={24} alt="calender" className="filter-grey"/>
